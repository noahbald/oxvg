...
fn parse_roxmltree() {
  ...
  <style>rect { fill: blue; }</style>
    ...
    assert_eq!(
        ...
        &Attr::Width(LengthPercentage::Dimension(LengthValue::Px(300.0)))
    );
    assert_eq!(
        &*attributes.item(4).unwrap(),
        &Attr::Height(LengthPercentage::Dimension(LengthValue::Px(200.0)))
    );
    ...
    assert_eq!(
        &*attributes.item(2).unwrap(),
        &Attr::Fill(SVGPaint::Color(CssColor::RGBA(RGBA {
            red: 0,
            green: 0,
            blue: 0,
            alpha: 255
    ...
    assert_eq!(
        &*attributes.item(0).unwrap(),
        &Attr::CX(LengthPercentage::Dimension(LengthValue::Px(150.0)))
    );
    assert_eq!(
        &*attributes.item(1).unwrap(),
        &Attr::CY(LengthPercentage::Dimension(LengthValue::Px(100.0)))
    );
    assert_eq!(
        &*attributes.item(2).unwrap(),
        &Attr::RCircle(LengthPercentage::Dimension(LengthValue::Px(90.0)))
    );
    assert_eq!(
        &*attributes.item(3).unwrap(),
        &Attr::Fill(SVGPaint::Color(CssColor::RGBA(RGBA {
